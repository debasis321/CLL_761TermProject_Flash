...
dot.node('A', 'Start: Feed (T, P, z_i)', fillcolor=colors['start'], **style_common)
dot.node('A1', 'Load Thermodynamic Data\n(T_c, P_c, ω, MW, k_ij)', fillcolor=colors['data'], **style_common)
...
dot.node('E', 'Solve for Z_l, Z_v', fillcolor=colors['solve'], **style_common)
dot.node('E2', 'Check Phase Type\n(Liquid / Vapor / Two-Phase)\n(Z_i based)', shape='diamond', fillcolor=colors['decision'], **style_common)
...
dot.node('H', 'Solve Rachford-Rice for β', fillcolor=colors['solve'], **style_common)
dot.node('H2', 'Check Phase Type\n(Liquid / Vapor / Two-Phase)\n($K_i$ based)', shape='diamond', fillcolor=colors['decision'], **style_common)
dot.node('I', 'Check Convergence\n(Loop Stabilization)', shape='diamond', fillcolor=colors['decision'], **style_common)
...
dot.node('Solv1', 'Solver', fillcolor=colors['solve'], **style_common)
dot.node('Target', 'Targets\n(dP, dT, dQ, beta) ', shape='box', fillcolor=colors['adjuster'], **style_common)
